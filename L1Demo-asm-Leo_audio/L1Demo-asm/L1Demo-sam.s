...
__reset:
			...
			mov			#0x0000, w0				; Set PORTB to output all pins
			mov			w0, TRISB			
...
1:			
			...
			; Play some audio
			mov			PORTB, w0				; Generate sawtooth by counting up
			add			#255, w0				; Since the audio port is PB15-PB8, we need to increment
			mov			w0, PORTB				; by 255

			repeat #1600						; 100 usec delay 		
			nop									; removing the line above will result in drawing
												; rectangles as fast as possible
